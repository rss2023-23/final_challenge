...
VERTICAL_SLOPE = 0.29 # What slope of line do we want to consider a lane?
...
def cd_color_segmentation(image, obstruct_view=True, visualize=False):
	...
	lines = lines if not isinstance(lines, type(None)) else []
	...
	for line in lines:
		...
		elif slope > VERTICAL_SLOPE and x_1 < RIGHT_BOUND and x_2 > LEFT_BOUND:
